...
const PREVIEW_SLOTS = ['pc1', 'pc2', 'pc3', 'pc4', 'pc5'] as const;
...
function pickHeroPreviews(prompts: PromptGalleryItem[]): PromptGalleryItem[] {
  ...
  const out: PromptGalleryItem[] = [];
  for (let i = 0; i < 5; i++) {
    out.push(withImages[i % withImages.length]);
  }
  return out;
}
            ...
            <div className="op-landing-visual" aria-hidden={previews.length === 0}>
              {previews.map((item, i) => (
                ...
                >
                  ...
                  <div className="op-landing-card-tag">
